...
public class ImplementacaoCrud<T> implements InterfaceCrud<T> {
	...
	public List<?> getListagemSQLDinamica(String sql) throws Exception {
		validaSessionFactory();
		List<?> listagem = sessionFactory.getCurrentSession().createSQLQuery(sql).list();
		return listagem;
	}
...
/**
 * 
 * 				CUSTOMIZAÇÕES ELABORADAS POR EDUARDO HENRIQUE	
 */
	
	public List<T> finListOrderByPropertyCampo(Class<T> entidade, String propriedade) {
		validaSessionFactory();
		StringBuilder query = new StringBuilder();
