...
public class MensagemBeanView extends BeanManagedViewAbstract {
	...
	public void saveNotReturn() throws Exception {
			if (objetoSelecionado.getUsr_destino().getEnt_id()
					.equals(objetoSelecionado.getUsr_origem().getEnt_id())) {
				Messagens
			...
			if (objetoSelecionado.getUsr_destino() == null
					...
					|| objetoSelecionado.getUsr_destino().getEnt_id() <= 0) {
	...
	public void addDestinoMsg(@RequestParam Long codEntidade) throws Exception  {
		if (codEntidade != null && codEntidade > 0) {
				...
				objetoSelecionado.setUsr_destino(entidade != null ? entidade : new Entidade());
		}
	}
	...
	public String condicaoAndParaPesquisa() throws Exception {
		return " and entity.usr_origem.ent_id = "
				+ contextoBean.getEntidadeLogada().getEnt_id();
	}
