...
public class CidadeBeanView extends BeanManagedViewAbstract {
	...
	private String url = "/cadastro/localidade/cad_cidade.jsf?faces-redirect=true";
	private String urlFind = "/cadastro/localidade/find_cidade.jsf?faces-redirect=true";
	...
	public void excluir() throws Exception {
		if (objetoSelecionado.getCid_id() != null
				&& objetoSelecionado.getCid_id() > 0) {
	...
	public void findCidade(HttpServletResponse httpServletResponse,
			@RequestParam(value = "idCidade") Long idCidade)
			throws Exception {

			Cidade cidade = cidadeController.findUninqueByPropertyId(
					Cidade.class, idCidade, "cid_id");
			if (cidade != null) {
	...
	public List<SelectItem> getCidades() {
		return cidadeController.getListCidade();
	}
