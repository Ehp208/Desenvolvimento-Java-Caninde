...
public class EstadoBeanView extends BeanManagedViewAbstract {
	...
	private String url = "/cadastro/localidade/cad_estado.jsf?faces-redirect=true";
	private String urlFind = "/cadastro/localidade/find_estado.jsf?faces-redirect=true";
	...
	public void saveNotReturn() throws Exception {
		if (validarCampoObrigatorio(objetoSelecionado)) {
			if (objetoSelecionado.getRegistroPais() == null || (objetoSelecionado.getRegistroPais() != null && objetoSelecionado.getRegistroPais().getPai_id() == null)) {
				Pais pais = paisController.findUninqueByProperty(Pais.class, "BRASIL", "pai_nome"); 
				objetoSelecionado.setRegistroPais(pais);
			}
			list.clear();
