...
public class CepConverter implements Converter, Serializable {
	...
	public Object getAsObject(FacesContext arg0, UIComponent arg1, String codigo) {
		if (codigo != null && !codigo.isEmpty()) {
				return (Cep) HibernateUtil.getCurrentSession().get(Cep.class, new Long(codigo));
		}
		return codigo;
	}

	public String getAsString(FacesContext arg0, UIComponent arg1, Object objeto) {
		if (objeto != null && objeto.getClass().getTypeName().equals("br.com.project.model.classes.Cep")) {
			Cep c = (Cep) objeto;
			return c.getCep_id() != null && c.getCep_id() > 0 ? c.getCep_id().toString() : null;
		} else {
			return null;
		}
	}
