...
public class UtilitariaRegex implements Serializable{
	...
	public String dataInicial(String string) {
		String aux = new String(string);
	...
	public String dataFinal(String string) {
		String aux = new String(string);
		if (aux == null || aux.isEmpty()) {
			aux = "01-01-2099";
		}
	...
	public String valorInicial(String string) {
		String aux = new String(string);
		if (aux == null || aux.isEmpty()) {
			aux = "0";
		}
	...
	public String valorFinal(String string) {
		String aux = new String(string);
		if (aux == null || aux.isEmpty()) {
			aux = "99999999999";
		}
